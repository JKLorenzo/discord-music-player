...
import search from "apple-music-metadata";
import {
  Client,
...
export class Utils {
  ...
  static async playlist(
    ...
    if (SpotifyPlaylistLink) {
      ...
      YouTubeResult.songs = (
        YouTubeResultData.videos instanceof PlaylistVideos
          ? YouTubeResultData.videos.items
          : YouTubeResultData.videos
      )
